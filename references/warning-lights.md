...
These 13 `id` values are stable. Do not rename them. An agent presenting a picker must use these ids and numbers 1–13. The exact picker to show the owner is MCP `show_dashboard` (see `references/lamp-picker.md`), not a list of English names.
