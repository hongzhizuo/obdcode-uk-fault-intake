...
These 13 `id` values are stable. Do not rename them. An agent presenting a picker must use these ids and numbers 1–13 in this order. The exact menu to show the owner is `references/lamp-picker.md`.
